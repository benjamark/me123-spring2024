...
cp /home/me123/markben/assignment-starters/project-1/* .
source ~/.bashrc
conda activate me123
python3 rescale_stl.py
# rename zone to MAP
#awk 'NR==1{$2="MAP"; print $1, $2; next} /^  endsolid/{print "  endsolid MAP"; next} 1' hawaii.stl > temp.stl && mv temp.stl hawaii.stl
awk 'NR==1{$2="MAP"; for(i=3;i<=NF;i++) $i=""; print; next} /^  endsolid/{print "  endsolid MAP"; next} 1' hawaii.stl > temp.stl && mv temp.stl hawaii.stl
