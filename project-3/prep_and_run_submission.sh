...
cp /home/me123/markben/assignment-starters/project-3/* .
source ~/.bashrc
conda activate me123
python3 check_bbox.py
# rename zone to WALL
#awk 'NR==1{$2="WALL"; print $1, $2; next} /^  endsolid/{print "  endsolid WALL"; next} 1' superhero.stl > temp.stl && mv temp.stl superhero.stl
awk 'NR==1{$2="WALL"; for(i=3;i<=NF;i++) $i=""; print; next} /^  endsolid/{print "  endsolid WALL"; next} 1' superhero.stl > temp.stl && mv temp.stl superhero.stl
