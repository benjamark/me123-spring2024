...
assignment="assignment-t1"
recordedSubmissionsDir="/home/me123/markben/scripts/assignment-t1/recorded-submissions"
...
for studentDir in "$studentFoldersBase"/*; do
    ...
    for submissionDir in "$studentDir/$assignment/submission-"*; do
        ...
        if [ ! -f "$recordFile" ]; then
            ...
            /home/me123/markben/scripts/assignment-t1/prep_and_run_submission.sh "$submissionDir"
        fi
    done
done
