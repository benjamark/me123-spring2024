...
recordedSubmissionsDir="/home/me123/markben/scripts/project-2/recorded-submissions"
...
for studentDir in "$studentFoldersBase"/*; do
    ...
    for submissionDir in "$studentDir/$assignment/submission-"*; do
        ...
        if [ ! -f "$recordFile" ]; then
            ...
            /home/me123/markben/scripts/project-2/prep_and_run_submission.sh "$submissionDir"
        fi
    done
done
